...
{
    class AnteBracoDireitoDepois : Pose
    {
        protected override bool PosicaoValida(Skeleton esqueletoUsuario)
        {
            const double ANGULO_ESPERADO = 60;
       ...
       //     System.Console.WriteLine("Angulo: " + resultadoAngulo);
            ...
            //  bool maoDireitaDepoisCotovelo = maoDireita.Position.X > cotoveloDireito.Position.X;
         ...
         //   System.Console.WriteLine("maoDireitaDepoisCotovelo: " + maoDireitaDepoisCotovelo);
         //   System.Console.WriteLine("maoDireitaAlturaCotovelo: " + maoDireitaAlturaCorreta);
            return anguloCorreto &&
                  maoDireitaDepoisCotovelo &&
                  maoDireitaPosicaoCorreta && maoDireitaAlturaCorreta;
        }
    }
}
