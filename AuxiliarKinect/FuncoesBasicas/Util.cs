...
namespace AuxiliarKinect.FuncoesBasicas
{
    public static class Util
    {
        ...
        //Distância entre dois pontos não pode ser negativa, logo eleva ao quadrado e tira raiz
        ...
        //Calculando o resultado do produto de dois vetores
        ...
        //Calculando o produto do módulo dos vetores
        ...
        //Método que efetivamente calcula o produto escalar
        public static double CalcularProdutoEscalar(Joint articulacao1, Joint articulacao2, Joint articulacao3)
        {
            ...
            //O resultado é obtido em radianos, então convertemos este para graus ( * 180 / PI).
